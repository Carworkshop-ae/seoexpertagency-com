      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-extrabold text-[#4472C4]">
            SEO <span className="text-[#1F2937]">Expert Agency</span>
          </h1>
        ...
        <div className="bg-white rounded-lg border border-[#E5E7EB] shadow-sm p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input label="Email" name="email" type="email" required autoComplete="email" placeholder="admin@seoexpertsagency.com" />
