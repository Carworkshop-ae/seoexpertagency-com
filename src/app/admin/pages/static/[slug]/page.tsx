        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {sections.map((s, idx) => (
            <div key={s.id} className="bg-white rounded-lg shadow-card border border-[#E5E7EB] p-5">
              ...
              <SectionFields section={s} services={services} onChange={data => updateSection(s.id, data)} />
            </div>
          ))}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-card border border-[#E5E7EB] p-6 space-y-3">
            ...
            <div className="border border-[#E5E7EB] rounded-md p-3">
              <p className="text-xs text-[#059669]">seoexpertsagency.com{slug === 'home' ? '/' : `/${slug.replace(/-listing$/, '')}`}</p>
...
function SectionFields({ section, services, onChange }: { section: StaticSection; services: NamedRow[]; onChange: (data: Record<string, unknown>) => void }) {
