...
const merge = (s: Partial<ContactContent> | null): ContactContent => ({
  ...
  details: { visible: true, phone: '', whatsapp: '', email: 'info@seoexpertsagency.com', address: '', weekday_hours: 'Monday – Friday: 9am – 6pm', weekend_hours: 'Saturday – Sunday: Closed', ...s?.details },
      ...
      <div className="space-y-4">
        ...
        <AdminSectionCard title="SEO (Advanced)" defaultOpen={false}>
          <StaticSeoCard seoJson={p.seoJson} setSeoJson={p.setSeoJson} saveSeo={() => void p.saveSeo()} saving={p.saving}
            pageUrl="https://seoexpertsagency.com/contact" defaultTitle={c.hero.h1} defaultDescription={c.hero.subheadline} autoSchemas={['Organization']}
