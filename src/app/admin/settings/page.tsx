    ...
    <div className="max-w-2xl space-y-5">
      ...
      <AdminCard title="Business Information (Footer & Contact)">
        <div className="space-y-4">
          ...
          <Field label="Business Email" value={settings.footer_business_email} onChange={v => set('footer_business_email', v)} placeholder="info@seoexpertsagency.com" />
        ...
        <div className="space-y-4">
          ...
          {isResend ? (
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="From Email" value={settings.resend_from_email} onChange={v => set('resend_from_email', v)} placeholder="noreply@seoexpertsagency.com" />
